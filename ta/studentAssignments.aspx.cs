...
public partial class professor_studentAssignments : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = "SELECT * FROM studentAssignments WHERE id=2 ORDER BY dateOfSubmission DESC";
        ...
        while (reader.Read())
        {
            ...
            hl.NavigateUrl = "~/common/getStudentAssignments.ashx?id=3&UserId=" + reader["Userid"].ToString();
            hl.Target = "_blank";
