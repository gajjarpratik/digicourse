...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
        ...
        <br />
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" ContinueDestinationPageUrl="~/login.aspx" OnCreatedUser="CreateUserWizard1_CreatedUser" LoginCreatedUser ="False" AutoGeneratePassword="True">
            <WizardSteps>
